...
def get_forecast_plot_and_value(ward_code: str, db_loc: str = "data/", db_name: str = "crime_data_UK_v4.db"):
    ...
    try:
        ...
        # main SARIMAX call
        fig, forecast_value, imd = timeseries(ward_code=ward_code, db_loc=temp_db_folder, db_name=temp_db_name)
...
def get_clustered_map(ward_code: str, num_officers: int, external_forecast_value=None, db_loc: str = "data/", db_name: str = "crime_data_UK_v4.db", return_df=False):
    ...
    try:
        ...
        if external_forecast_value is not None:
            ...
            _, _, imd_value = timeseries(ward_code=ward_code, db_loc=temp_db_folder, db_name=temp_db_name)
        else:
